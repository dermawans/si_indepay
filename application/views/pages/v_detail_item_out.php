    ...
    <section class="panel">
        <div class="panel-body">
            ...
            <div class="text-right mr-lg">
                <a href="<?php echo site_url('item_out/print_item_out/'.$row->id_item_out)?>" target="_blank" class="btn btn-primary ml-sm"><i class="fa fa-print"></i> Print</a>
	            <a href="<?php echo site_url('item_out')?>" class="btn ml-sm btn-dark">Back</a>
            </div>
        </div>
    </section>
